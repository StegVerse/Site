...
def main() -> int:
    ...
    report = {
        ...
        "control_revision": "CURRENT_IPHONE_GOVERNED_MR_CUSTODY_V15_SOVEREIGN_PRIMARY_HOSTED_FALLBACK_PROPAGATION_USING_EXISTING_HB32_INTR_RUNTIME",
        "failures": failures,
    }
